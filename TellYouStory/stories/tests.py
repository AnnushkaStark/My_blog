...
class TestRankingArticlesView(TestCase):
    """
    Тестирование доступности страницы
    статей с упорядчиванеим по ранжированию
    """
    ...
    def setUp(self):
        ...
        self.client = Client()
        self.url = reverse("user_page")
        self.ranking_articles_url = reverse("ranking_articles")
        self.user = User.objects.create_user(
            username="testus", email="mytest@mail.com", password="123testpassS@"
        )
...
class TestMyOneStoryView(TestCase):
    ...
    def test_my_story_page(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "my_story.html")
        self.assertEqual(stories[0].title, "test_title_1")
        self.assertEqual(stories[0].topic, "testopic_1")
